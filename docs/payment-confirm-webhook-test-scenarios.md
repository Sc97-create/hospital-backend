...
|------|---------|-----------|------|
| UpdatePaymentManually (`/payment/confirm`) | ☐ Pass ☐ Fail ☐ Exceptions | | |
| Razorpay webhook (`/payment/webhook`) | ☐ Pass ☐ Fail ☐ Exceptions | | |
| FulfillPaidInvoice multi-batch / complex (Part D) | ☐ Pass ☐ Fail ☐ Exceptions | | |
| Cross-check: no double dispense (C12 + W2 + F8 + WF5) | ☐ Pass ☐ Fail | | |
| Notifications observed (confirm + webhook) | ☐ Pass ☐ Fail ☐ N/A | | |
